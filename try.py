...
training_set = train_datagen.flow_from_directory('experiments/dest_folder/train',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

# Creating the Test set
test_set = test_datagen.flow_from_directory('experiments/dest_folder/test',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
predict_dir_path='experiments/dest_folder/test_0/'
...
for file in onlyfiles:
    ...
    if classes == 0:
        print(file + ": " + 'with_mask')
        cat_counter += 1
    else:
        print(file + ": " + 'without_mask')
        dog_counter += 1
